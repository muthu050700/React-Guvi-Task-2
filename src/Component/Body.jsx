...
const Body = ({ signup }) => {
  ...
  return (
    <div
      className={`flex flex-col justify-center items-center mx-1 bg-stone-200 ${
        signup === "signup" ? "h-[50vh]" : "h-[50vh] lg:h-[90vh] sm:h-[85vh]"
      }`}
    >
      {signup === "signup" ? (
        <h2 className="lg:py-10 py-4 text-xl font-extrabold sm:text-3xl lg:text-4xl xl:text-5xl text-center text-stone-600 ">
          Ready to get started? Sign up now!
        </h2>
      ) : (
        <h2 className="py-4 text-xl font-extrabold sm:text-3xl lg:text-4xl xl:text-5xl  text-stone-600 ">
      ...
      <form className="">
        ...
        <button
          className="hover:tracking-wider hover:transition-all  border-stone-400 border-2 px-2 py-[6px] text-stone-600  rounded-lg ml-2 text-sl  sm:px-4 sm:py-3 lg:py-[17px]  xl:py-5 sm:text-lg lg:text-2xl xl:px-5 xl:text-xl"
          onClick={handleEmail}
        >
          Submit
        </button>
